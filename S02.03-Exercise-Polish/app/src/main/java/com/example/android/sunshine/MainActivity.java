...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorLoadingData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorLoadingData = (TextView) findViewById(R.id.error_loading_data);
    ...
    public void showWeatherDataView() {
        mErrorLoadingData.setVisibility(View.INVISIBLE);
    ...
    public void showErrorMessage() {
        ...
        mErrorLoadingData.setVisibility(View.VISIBLE);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null && mWeatherTextView.getVisibility() == View.VISIBLE ) {
